...
const teamStorageKey = "newcastle_team_competitions_v1";
const rosterStorageKey = "newcastle_team_rosters_v1";
const datesStorageKey = "newcastle_team_dates_v1";
const lineupStorageKey = "newcastle_team_lineups_v1";
const dtSessionKey = "newcastle_team_dt_session_v1";
...
let teams = readData(teamStorageKey, defaultTeams);
let rosters = readData(rosterStorageKey, { "Newcastle Team": defaultRoster });
let dates = readData(datesStorageKey, { "Newcastle Team": [] });
let savedLineups = readData(lineupStorageKey, {});
let selectedPlayer = "";
let assignments = {};
let activeDt = "Dysta";
...
window.addEventListener("load", () => {
    window.setTimeout(closeSplash, 3200);
});

window.setTimeout(closeSplash, 4700);
...
const refreshAllSelects = () => {
    [calendarTeamSelect, lineupTeamSelect, dtPlayerTeam, dtDateTeam].forEach((select) => {
        fillSelect(select);
    });
};
